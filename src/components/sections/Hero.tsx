      ...
      <div className="relative z-10 text-center px-6 max-w-4xl pt-24 md:pt-32">
        ...
        >
          ...
          <h1 className="text-6xl md:text-9xl font-display leading-[0.9] mb-8 text-carnaval-charcoal drop-shadow-xl">
            DE JEUGD VAN <br />
            <span className="inline-flex tracking-tighter"><span className="text-carnaval-red">GE</span><span className="text-carnaval-yellow">BRO</span><span className="text-carnaval-green">OK</span></span>
          </h1>
